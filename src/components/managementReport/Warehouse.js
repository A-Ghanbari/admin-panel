                ...
                <>
                    <Row gutter={[16, 0]}>
                        <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={12} >
                            <div className='section-card management-card'>
                                <h1>تعداد کالا های خارج شده از انبار از تاریخ <span>{startDay}</span>  تا  <span>{endDay}</span> </h1>
                                <div className='scroll-x ltr'>
                                    ...
                                    >
                                        ...
                                        <Area type="monotone" dataKey="productCountOutWarehouse" fill="#8884d8" stroke="#8884d8" unit=" عدد " name="خارج شده" />
                                    </ComposedChart>
                                </div>
                            </div>
                        </Col>
                        <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={12}>
                            <div className='section-card management-card'>
                                <h1>تعداد کالا های باقی مانده در انبار از تاریخ <span>{startDay}</span>  تا  <span>{endDay}</span> </h1>
                                <div className='scroll-x ltr'>
                                    <ComposedChart
                                        data={data}
                                        XAxisKey="date"
                                    ...
                                    >
                                        <CartesianGrid stroke="#dbd3d0" />
                                        <Line type="monotone" dataKey="productCountInWarehouse" stroke="#ff7300" unit=" عدد " name="باقی مانده" />
                                    </ComposedChart>
                                </div>
                            </div>
                        </Col>
